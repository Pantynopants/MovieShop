...
namespace Infrastructure.Data
{
    public class MovieShopDbContext: DbContext
    {
        ...
        {
            //more control on table name and pk
        ...
        private void ConfigureMovie(EntityTypeBuilder<Movie> builder)
        {
            ...
            builder.Ignore(m => m.Rating);//not creating a column, remain a property in class

            builder.HasIndex(m => m.Title);//create index on column
